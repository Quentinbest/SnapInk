...
const defaultSettings: Settings = {
  ...
  hotkeys: [
    { action: 'capture_area', shortcut: 'CommandOrControl+Shift+4' },
    { action: 'capture_screen', shortcut: 'CommandOrControl+Shift+3' },
    { action: 'capture_window', shortcut: 'CommandOrControl+Shift+5' },
    { action: 'capture_scrolling', shortcut: 'CommandOrControl+Shift+6' },
    { action: 'capture_ocr', shortcut: 'CommandOrControl+Shift+7' },
    { action: 'repeat_last', shortcut: 'CommandOrControl+Shift+R' },
  ],
